...
function createPriceIcon(L, property, isSelected) {
  const label = getPriceLabel(property.price)
  ...
  useEffect(() => {
    ...
    const initializeMap = async () => {
      ...
      markers.forEach(({ property, coordinates }) => {
        ...
        marker.on('mouseover', () => {
          marker.setIcon(createPriceIcon(L, property, true))
        })

        marker.on('mouseout', () => {
          marker.setIcon(createPriceIcon(L, property, false))
        })
