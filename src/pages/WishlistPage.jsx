...
export default function WishlistPage() {
  ...
  const wishlistCollections = [
    { id: 'all', label: t('allSaved'), description: t('allSavedDesc') },
    { id: 'weekend', label: t('weekendIdeas'), description: t('weekendIdeasDesc') },
    { id: 'family', label: t('familyTrip'), description: t('familyTripDesc') },
    { id: 'work', label: t('workFriendly'), description: t('workFriendlyDesc') },
  ]
        ...
        <div className="space-y-8">
          ...
          {filteredProperties.length === 0 ? (
            <div className="rounded-[28px] border border-gray-200 bg-white px-6 py-14 text-center">
              <p className="text-sm font-semibold text-dark">{t('emptyCollection')}</p>
